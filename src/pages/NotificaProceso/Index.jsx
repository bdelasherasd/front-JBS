...
const Index = () => {
  ...
  let [correos, setCorreos] = useState("");
  ...
  const onSubmit = async (
    ...
    try {
      let response = await fetch(`${ip}:${port}/NotificaProceso/agenda`, {
        method: "POST",
        mode: "cors",
        headers: {
    ...
    <Container maxWidth="lg" sx={{ mt: 0 }}>
      ...
      >
        <Typography variant="h6" sx={{ p: 2 }} gutterBottom>
          Agenda Notificador de Procesos
        </Typography>

        <Formik
          initialValues={{ dia: "0", hora: "", minuto: "", correos: "" }}
          onSubmit={onSubmit}
          ...
          {({
            ...
            >
              ...
              <TextField
                ...
                onBlur={handleBlur}
                id="correos"
                label="Ingrese Correos"
                fullWidth
                sx={{ mb: 3 }}
                error={errors.correos && touched.correos}
                helperText={errors.correos && touched.correos && errors.correos}
              />
